---
title: "تطوير تطبيق ويب CRUD مع Google Sheets | Bulk & Sorting | الجزء الثاني"
description: "في هذا المقال سنكمل تطوير تطبيق الويب (CRUD Web App) المرتبط بـ Google Sheets باستخدام Google Apps Script."
categories: ["projects"]
tags: ["html-css-practical", "js-practical"]
draft: false
authors:
  - mahmoudadel
slug: "improve-web-app-with-google-sheets-and-app-scripts"
weight: -19
---

في هذا المقال سنكمل تطوير تطبيق الويب (CRUD Web App) المرتبط بـ Google Sheets باستخدام Google Apps Script.

هذا المقال هو الجزء الثاني من السلسلة
وفيه سنضيف مميزات متقدمة ونطوّر واجهة المستخدم (UI) للتطبيق.

{{< youtubeLite id="9rhKY9KJM5A" label="Bookmark Web App - Part 2" >}}
...
- [GitHub Repo](https://github.com/CodeZelo/BookmarkSheet) ]
- [Live Demo](https://codezelo.github.io/BookmarkSheet/)
- [Playlist](https://www.youtube.com/playlist?list=PLSZA91FTqBGVBQG6x5PJnXWmNI1WOsvUF)

## أسئلة سريعة (FAQ)

> [!QUESTION] **هل المشروع مناسب للمبتدئين؟**
> نعم, يكفي فقط أن يكون لديك أساسيات الـ HTML, CSS, Javascript.

> [!QUESTION] **هل الكود متاح؟**  
> نعم، على الـ Github.

> [!QUESTION] **ما المتطلبات قبل مشاهدة الفيديو؟**
